      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 mt-10 w-full max-w-5xl">
        {skills.map((skill, index) => {
          ...
          return (
            <div
              key={index}
              className="flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl p-6 shadow-lg hover:scale-105 transition-all"
            >
              <IconComp size={60} />
