...
//       glow: "hover:drop-shadow-[0_0_8px_rgb(59,130,246)]",
//       label: "GitHub"
//     },
//     {
//       icon: <BsWhatsapp size={24} className="icon" />,
//       href: whatsUrl,
//       color: "hover:text-[#25D366]",
//       glow: "hover:drop-shadow-[0_0_8px_rgba(37,211,102,0.8)]",
//       label: "WhatsApp"
//     },
//     {
//       icon: <FaLinkedinIn size={20} className="icon" />,
//       href: linkUrl,
//       color: "hover:text-[#0A66C2] hover:bg-[#0A66C2] hover:text-white",
//       glow: "hover:drop-shadow-[0_0_8px_#0A66C2]",
//       label: "LinkedIn"
//     },
//     {
//       icon: <img src="/gmail.png" alt="Gmail" className="icon w-6 h-6" />,
//       href: mailUrl,
//       color: "hover:bg-blue-100 hover:text-[#0A66C2]",
//       glow: "hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.8)]",
//       label: "Gmail"
//     },
//     {
//       icon: <img src="/na.png" alt="Naukri" className="icon w-5 h-5" />,
//       href: naukriUrl,
//       color: "hover:bg-blue-900 hover:text-[#25D366]",
//       glow: "hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.8)]",
//       label: "Naukri"
//     }
//   ];
...
//           {/* Text Content */}
//           <div className="about-text mb-12 lg:mb-16">
...
//                     rounded-2xl bg-gray-800/80 backdrop-blur-sm 
...
//         <div className="about-text mt-16 lg:mt-20">
