  ...
  return (
    <>
      <div className="relative w-full h-screen overflow-hidden">
              ...
              <div className="w-full h-full perspective">
                <div className="relative w-full h-full flex justify-center">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-44 sm:w-52 md:w-60 lg:w-68 h-80 sm:h-96 md:h-[30rem] lg:h-[34rem] rounded-2xl bg-black"></div>
                  </div>

                  <div
                    className="relative w-44 sm:w-52 md:w-60 lg:w-68 h-80 sm:h-96 md:h-[30rem] lg:h-[34rem] transition-transform duration-500 transform-style preserve-3d hover:rotate-y-180 z-10"
        ...
        <div
          className={`fixed top-1/3 left-0 bg-green-700 text-white px-4 sm:px-6 lg:px-8 py-3 sm:py-4 text-base sm:text-lg lg:text-xl rounded-lg shadow-lg z-50 
        ...
        {/* Welcome Toast */}
        <div
          className={`fixed top-4 sm:top-6 lg:top-8 left-1/2 transform -translate-x-1/2 w-full max-w-xs sm:max-w-sm md:max-w-md px-4 z-50
            transform transition-all duration-500 ease-out
            ${showWelcomeToast ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}
        >
          <div className="min-h-16 sm:min-h-20 mx-auto text-center bg-gradient-to-br from-[#1f1c2c] to-[#928DAB]
            text-white px-4 sm:px-5 py-3 sm:py-4 rounded-2xl shadow-2xl backdrop-blur-lg
            border border-white/40
            flex items-center justify-center gap-3 sm:gap-4 transition-all duration-1000"
          >
            {/* Icon or Avatar */}
            <div className="bg-white/10 p-2 sm:p-3 rounded-full shadow-inner ring-2 ring-pink-400/50 animate-pulse">
              <svg
                xmlns="http://www.w3.org/2000/svg"
